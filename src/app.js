...
class App {
    ...
    initPages() {
        ...
        <div id="main">
            ...
            <div id="title">
                马生重开模拟器<br>
                <div style="font-size:1.5rem; font-weight:normal;">废话少说模式</div>
            </div>
        ...
        propertyPage.find("#start").click(() => {
            ...
            this.#life.restart({
                ...
                SCI: groups.SCI.get(),
                STR: groups.STR.get(),
                HNY: Math.floor(groups.HMY.get()/2),
                LYT: Math.floor(groups.HMY.get()/2),
                GNR: Math.floor(groups.HMY.get()/2),
                KID: Math.floor(groups.HMY.get()/2),
                LAG: Math.floor(groups.HMY.get()/2),
                SPR: 5,
